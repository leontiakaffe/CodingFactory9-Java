...
public class Account {
	 ...
	 * @throws {@link NegativeAmountException}	if the amoount is negative
	 */
	public void deposit(double amount)throws NegativeAmountException{
		...
		try {
			...
			System.err.println("Megative amount = " + amount + " is not allowed" + "\n" + e.getMessage());
			throw e;
		}
	}
	 ...
	 * @throws NegativeAmountException	if the amount is negative, the balance is insufficient,
	 ...
	 * @return	the string representation of the {@link Account} oblect.
	 */
